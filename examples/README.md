...
- `07_plot_styles.jl`: controlled comparison of the `:sans` and `:tex` visual
  styles with the result panel independently enabled and disabled.
...
`examples/output/`. Maintainers can intentionally regenerate its eight tracked
