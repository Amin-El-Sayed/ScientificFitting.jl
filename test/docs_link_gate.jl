...
# Page routes exist in source; plots and downloads may be generated by @example.
# docs_html_link_gate checks every rendered asset after the documentation build.
@testset "Documentation page links" begin
    ...
    for page in docs_markdown_files()
        ...
        @testset "$(relpath(page, ROOT))" begin
            for target in markdown_targets(text)
                ...
                endswith(resolved, ".md") && @test isfile(resolved)
            end
