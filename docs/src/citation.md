...
| [NativeMinuit.jl](https://github.com/fkguo/NativeMinuit.jl) / [Minuit2.jl](https://github.com/JuliaHEP/Minuit2.jl) | A Julia port / Julia bindings to C++ Minuit2. Both expose minimization and likelihood error analysis. The v0.3 development branch provides an optional NativeMinuit adapter; Minuit2 is not integrated. |
...
| [Distributions.jl](https://juliastats.org/Distributions.jl/stable/) | Probability distributions and density/mass evaluation. v0.2 supports likelihood callbacks; v0.3 development adds fixed error objects and `fit_distribution` factories. |
| [NumericalDistributions.jl](https://github.com/mmikhasenko/NumericalDistributions.jl) / [DistributionsHEP.jl](https://github.com/JuliaHEP/DistributionsHEP.jl) | Numerically normalized distributions / HEP-specific shapes and extended mixtures. The v0.3 unbinned adapter reuses their models and retains the extended yield term. Binned/composite coverage is still being completed. |
| [BuildConstructors.jl](https://github.com/RUB-EP1/BuildConstructors.jl) | Constructs domain models from named parameters and metadata. v0.3 development adds an optional solver-independent adapter, preserving shared/fixed state and reconstructing the fitted model. |
