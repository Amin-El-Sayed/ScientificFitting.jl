...
<img class="jufitter-plot jufitter-plot-dark" data-jufitter-plot-group="linear-calibration" data-jufitter-plot-style="lab" src="../assets/gallery/linear_calibration_lab_dark.png" alt="Linear calibration fit in dark lab style">
